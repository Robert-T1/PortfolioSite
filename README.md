...
## Note
As of 7/7/2026, I experimented with Claude’s Fable 5 and the desktop workflow to clean up the look of this portfolio site. No major technical changes were made. The original site project was human-written as part of my process of learning React and related technologies.

I used Claude mainly to give the existing site a new coat of paint, not to replace the core work or learning that went into building it.
