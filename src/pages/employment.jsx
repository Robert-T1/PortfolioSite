    ...
    return (
        <div className="container">
            ...
            <p className={styles.description}>
                ...
                <EmploymentElement description="Work as a retail associate supporting customer service, sales, and daily store operations, with a strong track record of punctuality and reliability. Gain experience using both customer-facing and internal store systems. Recognized as Front End Team Member of the Month for performance.."
                 label="Lowe's - Retail Associate" tenure="Novemeber 2024 - Now" employmentType="Part-Time"/>
